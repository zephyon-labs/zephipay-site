...
import { EconomicEventExplorer } from "@/components/marketing/agent-learning";
...
export default function AIHowItWorksPage() {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-transparent text-foreground">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.92fr_1.08fr] xl:gap-20">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-6 text-5xl font-semibold tracking-[-0.055em] sm:text-7xl lg:text-[5.25rem] lg:leading-[0.98]">
                Understand how AI agents transact.
              </h1>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-foreground-secondary">
                Explore how identity, permissions, policy, risk, settlement,
                verification, and receipts work together before an autonomous
                payment is allowed to complete.
              </p>
      ...
      <Section id="pay-for-ai-services" className="scroll-mt-28">
        <Container>
          <div className="grid gap-10 border-t border-border-subtle pt-20 lg:grid-cols-[1fr_0.9fr]">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-foreground-secondary">
                Zephyon supports HTTP-native AI payments that allow autonomous software to purchase protected digital resources without subscriptions or manual checkout. The x402 standard becomes one part of a broader economic event coordinated by the Zephyon Runtime.
