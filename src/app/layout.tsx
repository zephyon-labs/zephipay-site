...
export const metadata: Metadata = {
  title: "ZephiPay | Modern payments without the complexity",
  description: "ZephiPay coordinates clear, trusted payment experiences for people, businesses, creators, and intelligent systems.",
};
